	...
	return (
		<div className="flex min-h-screen flex-col">
			...
			<div className="grow px-5 py-4 pb-28">
				...
				<ChatRoomMessageList messages={messages ?? []} myProfileId={profile.id} />
			</div>

			<form
				onSubmit={handleSubmit}
				className="border-line bg-surface/80 fixed bottom-0 left-1/2 z-10 flex w-full max-w-md -translate-x-1/2 items-center gap-2 border-t px-4 pt-3 pb-6 backdrop-blur-xl">
				<input
					value={content}
