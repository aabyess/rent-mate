...
export function AdminDashboardReportSectionContext({
	...
	const { data: content, isPending, isError } = useReportContextQuery(context);

	return (
		<div className="bg-surface flex flex-col gap-1 rounded-xl px-3.5 py-2.5">
